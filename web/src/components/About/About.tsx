    ...
    <div className="flex flex-col h-screen">
      ...
      <div className=" flex justify-center items-center flex-grow">
        <div className="h-full div bo-blue-200 p-1 grid grid-cols-4 grid-rows-9 gap-2 w-screen">
          ...
          <div className="div bg-custom-blood-red text-white text-center text-5xl py-4 rounded-lg col-span-4 sm:row-span-1">
            5
          </div>

          <div className=" bg-custom-blood-red text-white text-center text-5xl py-4 rounded-lg md:row-span-4 md:col-span-1  col-span-4 row-span-1">
            9
          </div>
          <div className="div bg-custom-blood-red text-white text-center text-5xl py-4 rounded-lg  md:col-span-3 md:row-span-4 col-span-4 row-span-5  ">
            10
          </div>
        </div>
      </div>
